...
<template>
  ...
  <div else>
    <Panel>
      ...
      <p>Individual contributions are difficult to encapsulate into simple statistics, but we hope that these summaries
        can help showcase the work individuals have put into the database.</p>
      <Card>
        <template #content>
