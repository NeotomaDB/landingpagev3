...
<template>
    <div v-if="!datasetid">
        <Panel>
            ...
            <p>
                This page leads to information relating to Neotoma datasets themselves. It includes information about
                dataset contacts, publications and other critical information about Neotoma records.
            </p>
            <p>
                Dataset pages also include information about taxa presence at sites, and other associated metadata. From
                the dataset landing pages you can download JSON formatted versions of the data to be used locally.
            </p>
            <Card>
                <template #content> Dataset search coming soon. </template>
            </Card>
        </Panel>
    </div>
    <div v-else>
