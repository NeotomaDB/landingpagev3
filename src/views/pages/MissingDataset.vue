...
<template>
    <Panel>
        ...
        <p>
            This dataset does not exist in Neotoma. It may have been removed from Neotoma, or a new dataset ID and DOI
            has been added to supercede this record.
        </p>
        <p>
            To find the new dataset, you can examine the DOI metadata and search by sitename, contributor or dataset
            type using <a href="https://apps.neotomadb.org/explorer">Neotoma Explorer</a>, the
            <a href="https://cran.r-project.org/web/packages/neotoma2/index.html">neotoma2 R package</a> or the
            <a href="https://api.neotomadb.org">Neotoma API</a>.
        </p>
        <p>
            You may also use the <a href="https://commons.datacite.org/" target="_blank">DataCite Commons</a> to check
            the DOI.
        </p>
