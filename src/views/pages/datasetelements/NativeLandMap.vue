...
<template>
    <div v-if="!loadingnat">
        ...
        <Panel
            id="nativeland"
            :class="{ custom: !hasFeatures, norm: hasFeatures }"
            toggleable
            collapsed
        ...
        >
            ...
            <div id="griddiv_nlm" style="display: grid; grid-template-columns: 1fr 1fr">
                ...
                <div v-if="!hasFeatures">
                    <p>
                        This site does not intersect any Indigenous territorries currently mapped by the Native Land
                        project.
                    </p>
                </div>
                ...
                <div v-if="hasFeatures" style="font-size: 13px">
                    ...
                    <span v-for="(feat, index) in vectorSource2.getFeatures()">
                        <span
                            v-if="
                                index + 1 != vectorSource2.getFeatures().length &&
                                index + 2 != vectorSource2.getFeatures().length
                            "
                        >
                    ...
                    <span
                        >, according to the <a href="https://native-land.ca/" target="_blank">Native Land</a> mapping
                        project.</span
                    >
                    <p>
                        Neotoma’s stewards and users come from all over the world. Wherever we are and wherever we
                        collect and curate data, we acknowledge that we are on Indigenous land.
                    </p>

                    <p>
                        Naming the ways that Neotoma’s data have been and are now entangled with the violences of
                        settler-colonialism is a necessary component of ethical data stewardship. We acknowledge that
                        Neotoma’s archive has resulted in part from a process of colonial extraction, by which
                        scientists exploit the natural and cultural wealth of Indigenous nations without consultation or
                        provision of reciprocal benefit. As well, we acknowledge that Neotoma's data model can objectify
                        the sacred kin of Indigenous peoples.
                    </p>
                    <p>
                        We respect the sovereign status of the Indigenous peoples from whose lands our data derive, and
                        we hold ourselves accountable to those peoples. Neotoma is cataloging the Indigenous cultural
                        affiliation of its data records and exploring new ways to represent those records as an element
                        of its participation in the
                        <a href="https://eos-rcn.github.io/web/home" target="_blank"
                            >Ethical Open Science research coordination network</a
                        >, in order to work toward more ethical stewardship of Indigenous data.
                    </p>
                    <p>
                        This language has been borrowed in part from
                        <a target="_blank" href="https://localcontexts.org/">Local Contexts</a>.
                    </p>
                </div>
            </div>
        </Panel>
