...
<template>
  <Panel toggleable>
    ...
    <div class="grid">
      <div class="col">
        <Button @click="calljson()" aria-label="Download Raw JSON Data" label="Download Raw JSON Data"
          style="margin:10px;width:100%" rounded />
      </div>
      <div class="col">
        <Button as="a" label="View Data in Neotoma Explorer" aria-label="View Data in Neotoma Explorer"
          :href="'https://apps.neotomadb.org/explorer/?datasetids=' + props.title.site.datasets[0].datasetid"
          target="_blank" rel="noopener" style="margin:10px;text-decoration: none;width:100%" rounded />
      </div>
    </div>
