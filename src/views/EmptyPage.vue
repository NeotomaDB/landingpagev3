...
<template>
  <panel>
    ...
    <img :src=imageref style="width:100%"
      alt="A zoomed in map with points showing the location of Neotoma sample sites.">
    ...
    <p>To access information about an individual Neotoma Dataset include the dataset ID in the URL:
      <strong>https://data.neotomadb.org/{DatasetID}</strong>, for example, the dataset for the <em>Lake Tulane Loss on
        ...
        to="/datasets/2662">https://data.neotomadb.org/2662</router-link>.
    </p>
    <p><strong>NOTE:</strong> This page is informational and will not directly lead to datasets. To explore Neotoma
      datasets
      interactively please use the <a href="https://apps.neotomadb.org/Explorer">Neotoma Explorer</a>.</p>
    <p>This application is managed and maintained as an open-source project on the <a
        href="https://github.com/NeotomaDB/landingpagev3">Neotoma GitHub Repository</a>.</p>
