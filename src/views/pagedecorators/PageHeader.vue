...
const OrcidLogin = defineAsyncComponent(() => import('./headercomponents/OrcidLogin.vue'))
        ...
        <template #content>
            <div class="header-container">
                <div class="header-logo">
                    <img src="@/assets/packrat.png" width="185" height="130" alt="Neotoma logo, a packrat" />
                </div>
                <div class="header-info">
                    <h1>Neotoma Paleoecology Database</h1>
                    <p class="header-subtitle">Dataset Archiving</p>
                    <a href="https://data.neotomadb.org" class="header-link"> https://data.neotomadb.org </a>
                </div>
            </div>
